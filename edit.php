...
<body>
    <div class="container" style="margin-top: 50px;">
        ...
        <form action="/laba_vlad/controller.php?table=<?php echo urlencode($table_name); ?>&id=<?php echo urlencode($id); ?>" method="POST">
            ...
            <?php foreach ($columns as $column): ?>
                ...
                ?>
                    <div class="form-group" style="font-size: large;">
                        <label style="padding: 0 px; text-align: left;" for="<?php echo htmlspecialchars($column['Field']); ?>">
                            <p style="color: #37745B;margin-top:5px;"><?php echo htmlspecialchars($column['Field']); ?></p>
                        </label>
